...
namespace SyncThinkTechnology.Controllers
{
    public class CustomerDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerId,CustomerName,CustomerPhoneNumber,CustomerEmail,CustomerAddress")] CustomerDetail customerDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,CustomerName,CustomerPhoneNumber,CustomerEmail,CustomerAddress")] CustomerDetail customerDetail)
        {
            if (ModelState.IsValid)
            {
