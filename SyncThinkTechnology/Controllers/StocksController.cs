...
namespace SyncThinkTechnology.Controllers
{
    public class StocksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Quantity,ProductId,ProductBarcode")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Quantity,ProductId,ProductBarcode")] Stock stock)
        {
            if (ModelState.IsValid)
            {
