...
namespace SyncThinkTechnology.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,CategoryId,ProductBarcode,TotalOrders")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,CategoryId,ProductBarcode,TotalOrders")] Product product)
        {
            if (ModelState.IsValid)
            {
